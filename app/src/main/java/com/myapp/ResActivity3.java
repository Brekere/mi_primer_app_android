        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition()==0) {
                    Intent intent = new Intent(ResActivity3.this, comidaActivity3.class);
                    startActivity(intent);
                }
                if (tab.getPosition()==1) {
                    Intent intent = new Intent(ResActivity3.this, bebidaActivity3.class);
                    startActivity(intent);
                }
                if (tab.getPosition()==2) {
                    Intent intent = new Intent(ResActivity3.this, complementoActivity3.class);
                    startActivity(intent);
                }
            }
